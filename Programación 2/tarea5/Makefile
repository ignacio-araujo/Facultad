...
MODULOS = utils info cadena binario iterador pila colaBinarios avl conjunto colCadenas usoTads
...
# casos de prueba
CASOS = 00 01 02 03 04 05 06 07 08 200 300 400 m-40 t-avlAbinario t-conjunto
